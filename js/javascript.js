(function (window) {
    ...
    function varters(id) {
        var el = document.getElementById(id),
            varters = el.innerHTML.replace("&amp;", "&").split(""),
            heading = "";

        for (var i = 0, n = varters.length, varter; i < n; i++) {
            varter = varters[i].replace("&", "&amp");
            heading += varter.trim() ? '<span class="varter-' + i + '">' + varter + "</span>" : "&nbsp;";
        }
